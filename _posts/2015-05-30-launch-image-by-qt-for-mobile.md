---
layout: post
image: https://fastly.jsdelivr.net/gh/missdeer/blog@master/media/2015-05-30/ioslaunchimagefiles.png
author: missdeer
...
- 首先，按Apple的要求生成各个屏幕对应launch image文件，文件名也要统一按要求的来，如图![](https://fastly.jsdelivr.net/gh/missdeer/blog@master/media/2015-05-30/ioslaunchimagefiles.png)
...
- 首先，把图片文件放在android/res/drawable目录下，如图![](https://fastly.jsdelivr.net/gh/missdeer/blog@master/media/2015-05-30/androidsplashscreen.png)
