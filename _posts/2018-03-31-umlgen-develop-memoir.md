---
layout: post
image: https://cdn.jsdelivr.net/gh/missdeer/blog@master/media/2018-03-31/mainwindow2.png
author: missdeer
title: "UMLGen开发踩坑"
...
![UMLGen main window](https://cdn.jsdelivr.net/gh/missdeer/blog@master/media/2018-03-31/mainwindow2.png)

程序是用Qt写的，开发过程中还是遇到一些坑，记录一下。

* QtSvg模块实现的SVG标准有限，不能支持某些SVG，比如下面两张图，使用Firefox或Chrome浏览器查看，一切正常，用QtSvg则惨不忍睹。

![math](https://cdn.jsdelivr.net/gh/missdeer/blog@master/media/2018-03-31/math.svg)

![math error](https://cdn.jsdelivr.net/gh/missdeer/blog@master/media/2018-03-31/math-error.png)

![latex](https://cdn.jsdelivr.net/gh/missdeer/blog@master/media/2018-03-31/latex.svg)

![latex error](https://cdn.jsdelivr.net/gh/missdeer/blog@master/media/2018-03-31/latex-error.png)
